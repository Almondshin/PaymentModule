...
public class PaymentDetails extends ValueObject<PaymentDetails> {
    ...
    @Builder
    public PaymentDetails(String tradeNum, String paymentType, String rateSel, String amount, String offer, String useCount, String trTrace, String paymentStatus, Date trDate, String extraAmountStatus, String memo) {
    ...
    protected Object[] getEqualityFields() {
        return new Object[]{tradeNum, paymentType, rateSel, amount, offer, useCount, trTrace, paymentStatus, trDate, extraAmountStatus, memo};
    }
}